...
<template>
  <ul class="flex justify-end items-center gap-x-2">
    <li>
      <NuxtLink
        class="block w-full h-full border rounded-full px-3 py-1 text-white/95 border-blue-700 bg-blue-600 lg:text-current lg:border-gray-200 lg:bg-transparent lg:hover:bg-gray-50"
        >登录</NuxtLink
      >
    </li>
    <li>
