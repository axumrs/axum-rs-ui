...
<template>
  <Mask
    class="lg:hidden transition-all duration-300 z-[1]"
    :class="{
  ...
  <Container class="grid grid-cols-12 items-start gap-x-4 my-6">
    <aside
      class="fixed top-0 bottom-0 bg-white transition-all duration-300 shadow-xl border z-[2] lg:z-auto lg:shadow-none lg:rounded-lg lg:opacity-100 lg:visible lg:block lg:static lg:w-full lg:col-start-1 lg:col-span-2"
      :class="{
